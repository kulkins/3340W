...
motor leftMotorC = motor(PORT4, ratio6_1, true);
motor_group lefts = motor_group(leftMotorA, leftMotorB, leftMotorC);
motor rightMotorA = motor(PORT1, ratio6_1, false);
motor rightMotorB = motor(PORT9, ratio6_1, false);
motor rightMotorC = motor(PORT14, ratio6_1, true);
motor_group rights = motor_group(rightMotorA, rightMotorB, rightMotorC);
Drive chassis(
